...
export const Header = ({ isDarkMode }: { isDarkMode: boolean }) => {
  return (
    <div className="max-w-7xl relative mx-auto py-20 md:py-40 px-4 w-full left-0 top-0">
      <h1
        className={twMerge(
          "text-2xl md:text-7xl font-bold",
      ...
      <p
        className={twMerge(
          "max-w-2xl text-base md:text-xl mt-8",
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className={twMerge(
          "absolute inset-0 h-full w-full opacity-0 group-hover/product:opacity-80 pointer-events-none",
